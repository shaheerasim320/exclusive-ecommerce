    ...
    return (
        <div className="w-full flex flex-col justify-between h-full">
            ...
            <div className="relative">
                {/* Badge */}
                <div
                    className={`${product?.stock === 0 ? "bg-[#DB4444]" : product?.new ? "bg-[#00FF66]" : product?.discount > 0 ? "bg-[#DB4444]" : "hidden"} absolute top-2 left-2 text-white text-[10px] sm:text-xs px-2 py-1 rounded`}
                >
                    {product?.stock === 0
                        ? "Out Of Stock"
                        : product?.new
                ...
                {/* Delete Icon */}
                <div
                    className="absolute top-2 right-2 bg-white rounded-full p-1 sm:p-2 cursor-pointer"
                ...
                >
                    <Icon
                        ...
                        className={`${deleteHovered ? "text-[#DB4444] fill-[#DB4444]" : ""} w-4 h-4 sm:w-5 sm:h-5`}
                    />
                </div>
            ...
            <div className="mt-auto flex items-center justify-between pt-2">
                ...
                <div
                    className={`${
                        cartHovered ? "bg-[#CCC]" : "bg-[#F5F5F5]"
                    } p-1.5 sm:p-2 rounded-md cursor-pointer`}
                ...
                >
                    <Icon
                        ...
                        className={`${cartHovered ? "invert" : ""} w-4 h-4 sm:w-5 sm:h-5`}
                    />
                </div>
            </div>
        </div>
